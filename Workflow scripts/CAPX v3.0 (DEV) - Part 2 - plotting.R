...
#########################################################################################################
    ...
    ## 1.4. Set working directory
        ...
        dir.create("Output_CAPX_plotting", showWarnings = FALSE)
        setwd("Output_CAPX_plotting")
...
#########################################################################################################
    ...
    ### Read in cell.dat
        ...
        cell.dat <- fread("Clustered_TAXXX_all_data.csv")

        ## cell.dat.sub
        list.files(PrimaryDirectory, ".csv")
        cell.dat.sub <- fread("DimRed_TAXXX_all_data.csv")
