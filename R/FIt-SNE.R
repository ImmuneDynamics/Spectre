...
#' 
#' @param X No default. Matrix containing the data which dimension need to be reduced.
...
#' @param rand_seed Default = -1. Seed for random initialisation. Set to -1 by default to
...
fftRtsne <- function(X, 
    ...
    # this should be handled by the run.fitsne
