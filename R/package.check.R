...
package.check <- function()
{
  ...
  if(!is.element('flowCore', installed.packages()[,1])) stop('gridExtra is required but not installed')
  if(!is.element('Biobase', installed.packages()[,1])) stop('gridExtra is required but not installed')
  if(!is.element('flowViz', installed.packages()[,1])) stop('gridExtra is required but not installed')
  if(!is.element('FlowSOM', installed.packages()[,1])) stop('gridExtra is required but not installed')
  }
