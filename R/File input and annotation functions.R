#################################################################################
###### Spectre - file unput and anootation functions
#################################################################################
...
### file.annotate
    ...
    #sample.annotate <- function(x, # list of files
    #                            add.or.rmv) # are you adding or removing columns?
