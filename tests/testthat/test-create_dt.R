...
# Idk how to get around not doing this as we need to SeuratData needs to load Seurat?
library(Seurat)
...
test_that("Seurat RNA only object is converted", {
    ...
    dat <- suppressMessages(create.dt(pbmc))
...
test_that("SCE object is converted", {
    ...
    dat <- suppressWarnings(create.dt(sce))
